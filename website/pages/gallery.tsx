...
export default function gallery(props:PropsInterface) {
    ...
    for(let i:number = 0; i < sortedImages.length; i++) {
        circles.push(<div onClick={() => {setIndex(i)}} className={`rounded-full mt-auto m-2 lg:m-3 p-3 xl:p-4 2xl:p-5 bg-${index == i ? "primary": "gray-400"}`}></div>)
    }
    return (
        <div className="flex flex-col">
            ...
            <div className="relative mix-blend normal flex flex-row self-end mx-auto mt-6">{circles}</div>
