...
export default function info(props:PropsInterface) {
    ...
    let d = new Date();
    return (
        <div className="flex mx-auto justify-center items-center filter drop-shadow-xl h-144 p-4 w-full h-auto md:rounded-50px bg-gray-100">
            <div className="flex flex-col space-y-0 items-center text-black">
                <h1 className=" text-4xl lg:text-6xl text-primary">Hours</h1>
                ...
                <h1 className=" text-4xl lg:text-6xl text-primary">Phone</h1>
                <div className="text-xl">{phone}</div>
                <h1 className=" text-4xl lg:text-6xl text-primary">Location</h1>
