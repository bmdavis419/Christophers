...
`;
    ...
    mutation Mutation($createCateringFaqQuestion: String!, $createCateringFaqAnswer: String!) {
        createCateringFAQ(question: $createCateringFaqQuestion, answer: $createCateringFaqAnswer) {
          id
          question
          answer
        }
    ...
    return (
        ...
        {cards.map((card: {
				...
				return (
					<CateringFAQCard cateringFAQCard={card} key={card.id}/>
				)
			})}
        </div>
    )
