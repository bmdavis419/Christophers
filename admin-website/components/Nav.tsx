			...
			<div className="w-full">
				...
				<div className="flex justify-center">
					<ul className="text-center">
						...
						<li
							className={`navItem ${pageIndex === 11 && "ring-4 ring-white"}`}
							onClick={() => {
								setPageIndex(11);
							}}
						>
						...
						<li
							className={`navItem ${pageIndex === 12 && "ring-4 ring-white"}`}
							onClick={() => {
								setPageIndex(12);
							}}
						>
						...
						<li
							className={`navItem ${pageIndex === 15 && "ring-4 ring-white"}`}
							onClick={() => {
								setPageIndex(15);
							}}
						>
						...
						<li
							className={`navItem ${pageIndex === 16 && "ring-4 ring-white"}`}
							onClick={() => {
								setPageIndex(16);
							}}
						>
