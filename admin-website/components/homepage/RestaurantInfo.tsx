...
export default function RestaurantInfo(props: PropsInterface) {
	...
	return (
		<div className="mb-7 px-4 rounded-xl shadow-lg py-4 mx-5">
			<h1 className="text-center font-bold text-primary text-xl mb-3">
				Restaurant Info
			</h1>
			<div className="grid grid-cols-5 gap-4 ">
				...
				<div className="w-full flex justify-center">
					<button
						className="ml-4 bg-green-500 text-white rounded-lg px-2 py-1 hover:bg-green-400 inline-block disabled:opacity-50"
						disabled={!canUpdate}
						onClick={(e) => {
							setCanUpdate(false);
