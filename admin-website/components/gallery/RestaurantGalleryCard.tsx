...
export default function GalleryCard(props: PropsInterface) {
    ...
    mutation UpdateRestaurantGalleryImageMutation($updateRestaurantGalleryImageId: ID!, $updateRestaurantGalleryImageDescription: String, $updateRestaurantGalleryImageImage: String) {
        updateRestaurantGalleryImage(id: $updateRestaurantGalleryImageId, description: $updateRestaurantGalleryImageDescription, image: $updateRestaurantGalleryImageImage) {
          image
          description
          id
        }
	...
	const [deleteGalleryImage, { error: errorDelete, loading: loadingDelete }] =
		useMutation(gql`
        mutation UpdateRestaurantGalleryImageMutation($deleteRestaurantGalleryImageId: ID!) {
            deleteRestaurantGalleryImage(id: $deleteRestaurantGalleryImageId)
          }
		`);
			...
			<div className="ring-2 ring-primary rounded-xl px-5 py-5">
				...
				<div className="mb-2 flex justify-between w-full px-12">
					...
					<button
						...
						onClick={(e) => {
							deleteGalleryImage({
								variables: { deleteRestaurantGalleryImageId: updateState.id },
					...
					<button
						...
						onClick={(e) => {
							updateGalleryImage({
								variables: {
									updateRestaurantGalleryImageId: updateState.id,
									updateRestaurantGalleryImageDescription: updateState.description,
									updateRestaurantGalleryImageImage: updateState.image,
								},
								refetchQueries: [GET_GALLERY_IMAGES, "Query"],
							});
						}}
