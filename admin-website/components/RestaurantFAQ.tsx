...
`;
    ...
    mutation Mutation($createRestaurantFAQQuestion: String!, $createRestaurantFAQAnswer: String!) {
        createRestaurantFAQ(question: $createRestaurantFAQQuestion, answer: $createRestaurantFAQAnswer) {
          id
          question
          answer
        }
    ...
    return (
        ...
        {cards.map((card: {
				...
				return (
					<RestaurantFAQCard restaurantFAQCard={card} key={card.id}/>
				)
			})}
        </div>
    )
