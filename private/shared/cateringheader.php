	...
	<header>
		...
		<div class="navWrapper"> <!--Includes entire nav system-->
			<nav class="navBar" id="navBar"> <!--Just Includes the navbar which will float with the page-->
					<a id="homeCatering" href="<?php echo urlfor("christophers/catering/index.php"); ?>">Home</a> <!--Waiting for dynamic php statements -->
					<a id="menuCatering" href="<?php echo urlfor("christophers/catering/menu.php"); ?>">Menu</a> <!--Waiting for dynamic php statements -->
			</nav>
        ...
        <div id='mobileNav' class="mobileNavBar">
            ...
            <div class="mobileLinks">  
                <a href="<?php echo urlfor("catering/index.php"); ?>" id="navLink">Home</a>
                <a href="<?php echo urlfor("catering/menu.php"); ?>">Menu</a>
            </div>
        </div>
    </div>
	</div>
